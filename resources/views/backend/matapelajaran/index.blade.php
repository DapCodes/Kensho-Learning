        ...
        <div class="card-body py-3">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <button class="btn btn-primary btn-lg px-4" data-bs-toggle="modal" data-bs-target="#addMataPelajaranModal">
                                ...
                                <tr class="matapelajaran-row" data-matapelajaran-id="{{ $item->id }}">
                                    ...
                                    <td class="py-4">
                                        <div style="max-width: 300px;">
                                            @if($item->deskripsi)
                                                <p class="mb-0 text-muted" style="max-height: 60px; overflow: hidden; text-overflow: ellipsis;">
                                    ...
                                    <td class="py-4 text-center pe-4">
                                        ...
                                        <form id="delete-form-{{ $item->id }}" 
                                              action="{{ route('matapelajaran.destroy', $item->id) }}" 
                                              method="POST" 
                                              style="display: none;">
                                            @csrf
                                            @method('DELETE')
        ...
        @else
            ...
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-4 mx-auto" style="max-width: 400px;">
                    Mulai dengan membuat mata pelajaran pertama untuk mengorganisir konten pembelajaran Anda dengan lebih baik!
                </p>
                <button class="btn btn-primary btn-lg px-5" data-bs-toggle="modal" data-bs-target="#addMataPelajaranModal">
...
<script>
    ...
    function deleteMataPelajaran(mataPelajaranId, mataPelajaranName) {
        if (confirm(`Apakah Anda yakin ingin menghapus mata pelajaran "${mataPelajaranName}"?\n\nTindakan ini tidak dapat dibatalkan.`)) {
