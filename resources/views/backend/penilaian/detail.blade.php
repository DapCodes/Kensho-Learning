                        ...
                        <div class="col-md-3">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-info fw-bold">{{ $hasil->jumlah_benar }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-3 py-2 bg-white border-bottom">
                    ...
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar bg-success" role="progressbar"
                            style="width: {{ $hasil->jumlah_benar }}" aria-valuenow="{{ $hasil->jumlah_benar }}"
                                                        ...
                                                        @if ($detail->jawaban_peserta)
                                                            @if ($detail->soal->tipe === 'essay')
                                                                <div class="fw-medium">
                                                                    ...
                                                                    <div class="mt-2">
                                                                        <small class="text-muted">Jawaban essay akan
                                                                            dikoreksi secara manual oleh pemilik
                                                                            quiz</small>
                                                                    </div>
                                                                </div>
