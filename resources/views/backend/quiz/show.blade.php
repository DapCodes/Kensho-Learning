                ...
                @foreach($quiz->soals as $index => $soal)
                    <div class="question-item card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <div class="option-item d-flex align-items-center mb-2 p-2 rounded {{ $soal->jawaban_benar == 'A' ? 'bg-success-subtle border border-success' : 'bg-light' }}">
                                        <span class="badge {{ $soal->jawaban_benar == 'A' ? 'bg-success' : 'bg-secondary' }} me-3">A</span>
                                ...
                                <div class="col-md-6">
                                    <div class="option-item d-flex align-items-center mb-2 p-2 rounded {{ $soal->jawaban_benar == 'B' ? 'bg-success-subtle border border-success' : 'bg-light' }}">
                                        <span class="badge {{ $soal->jawaban_benar == 'B' ? 'bg-success' : 'bg-secondary' }} me-3">B</span>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="option-item d-flex align-items-center mb-2 p-2 rounded {{ $soal->jawaban_benar == 'C' ? 'bg-success-subtle border border-success' : 'bg-light' }}">
                                        <span class="badge {{ $soal->jawaban_benar == 'C' ? 'bg-success' : 'bg-secondary' }} me-3">C</span>
                                ...
                                <div class="col-md-6">
                                    <div class="option-item d-flex align-items-center mb-2 p-2 rounded {{ $soal->jawaban_benar == 'D' ? 'bg-success-subtle border border-success' : 'bg-light' }}">
                                        <span class="badge {{ $soal->jawaban_benar == 'D' ? 'bg-success' : 'bg-secondary' }} me-3">D</span>
