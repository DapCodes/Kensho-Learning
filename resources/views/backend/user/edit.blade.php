        ...
        <div class="card-body px-4 py-4">
            <div class="row align-items-center">
                <div class="col-9">
                    ...
                    <p class="text-white-75 mb-3">Ubah data {{ $user->name }} dengan mengisi beberapa form di bawah.</p>
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <h6 class="fw-medium text-muted mb-2">
                                <i class="ti ti-lock me-1"></i>Ubah Password (Opsional)
                            </h6>
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" class="btn btn-success px-4">
                                <i class="ti ti-user-check me-1"></i>Simpan Perubahan
                            </button>
