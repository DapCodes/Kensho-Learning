    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            ...
            @else
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('dasbor') ? 'active' : '' }}">
                        <a class="sidebar-link justify-content-between" href="{{ route('dasbor') }}">
                            <div class="d-flex align-items-center gap-3">
                                <span class="d-flex"><i class="ti ti-home"></i></span>
        ...
        <div class="fixed-profile p-3 mx-4 mb-3 bg-secondary-subtle rounded">
            <div class="hstack gap-3">
                ...
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit()" class="border-0 bg-transparent text-primary ms-auto" type="button" aria-label="logout" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="logout">
