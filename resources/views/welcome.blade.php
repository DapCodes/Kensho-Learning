                ...
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      @guest
                        ...
                        @else
                            <li class="nav-item">
                              <a class="scroll-to-section-toggle" href="{{route('dasbor')}}" role="button" aria-expanded="false">
                                Dasbor
                              </a>
                            </li>
                      @endguest
          ...
          <div class="owl-carousel owl-banner">
            <div class="item item-1">
              <div class="header-text">
                ...
                <p>Dengan Kenshō, proses belajar menjadi lebih mudah, menyenangkan, dan efektif untuk siapa saja, kapan pun, di mana pun.</p>
                <div class="buttons">
            ...
            <div class="item item-2">
              <div class="header-text">
                ...
                <p>Usaha yang kamu lakukan tidak akan sia-sia, karena bersama Kenshō kamu bisa meraih hasil terbaik setiap saat. Dimanapun dan kapanpun.</p>
                <div class="buttons">
                  <div class="main-button">
                      @guest
                            @if (Route::has('login'))
            ...
            <div class="item item-3">
              <div class="header-text">
                ...
                <p>Dengan pembelajaran online, kamu bisa menghemat waktu, belajar lebih fleksibel, dan menyesuaikan materi sesuai kebutuhanmu sendiri.</p>
                <div class="buttons">
                  <div class="main-button">
                      @guest
                            @if (Route::has('login'))
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              <h4>Pembelajaran</h4>
              <p>Kenshō menghadirkan tes yang mudah diakses dan dipahami, agar proses belajar menjadi lebih ringan dan menyenangkan.</p>
              <div class="main-button">
                      @guest
                            @if (Route::has('login'))
                                <a href="{{ route('login') }}">Mulai Sekarang</a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              <h4>Raih Goals</h4>
              <p>Raih tujuan dan cita-citamu bersama Kenshō, melalui pembelajaran yang terarah, efektif, dan sesuai kebutuhanmu.</p>
              <div class="main-button">
                <a href="#">Ayo Mulai</a>
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              ...
              <p>Kembangkan dirimu dengan mempelajari hal-hal baru bersama Kenshō, agar lebih siap menghadapi tantangan masa depan.</p>
              <div class="main-button">
      ...
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{asset('assets/frontend/images/course-01.jpg')}}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{asset('assets/frontend/images/course-02.jpg')}}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{asset('assets/frontend/images/course-03.jpg')}}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{asset('assets/frontend/images/course-04.jpg')}}" alt=""></a>
              <span class="category">Development</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{asset('assets/frontend/images/course-05.jpg')}}" alt=""></a>
              <span class="category">Wordpress</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{asset('assets/frontend/images/course-06.jpg')}}" alt=""></a>
              <span class="category">Webdesign</span>
